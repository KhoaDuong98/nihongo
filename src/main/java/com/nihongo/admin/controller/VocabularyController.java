...
public class VocabularyController {
    ...
    public String listCategoryVocabulary(@PathVariable("level") String level, Model model){
        ...
        model.addAttribute("listCateVocabularies",categoryVocabularyService.getCategoryVocabularyByLevelByLevel(level));


        return "category_vocabulary";
    }

    @GetMapping("/admin/vocabularies/{categoryVocabulary}/{level}")
    public String vocabularyByLevel(@PathVariable("level") String level,@PathVariable("categoryVocabulary") String categoryVocabulary, Model model){
        model.addAttribute("level", level);
        model.addAttribute("categoryVocabulary", categoryVocabulary);

        model.addAttribute("listLevel", levelService.findAll());

        model.addAttribute("vocabularies", vocabularyService.getVocabularyByLevelAndCategoryVocabulary(level,categoryVocabulary));
